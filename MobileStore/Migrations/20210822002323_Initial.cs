        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsPreferredMobile = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Amount = table.Column<int>(type: "int", nullable: false),
                    ProductWishlistId = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductWishlistItems", x => x.ProductWishlistItemId);
                    table.ForeignKey(
                        name: "FK_ProductWishlistItems_Mobiles_MobileId",
                        column: x => x.MobileId,
                        principalTable: "Mobiles",
                        principalColumn: "MobileId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductWishlistItems_MobileId",
                table: "ProductWishlistItems",
                column: "MobileId");
